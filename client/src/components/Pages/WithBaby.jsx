...
import BabyInfo from "../Partials/BabyInfo"
    ...
    function handleChanges(e){
     ...
     function handleCreate(e){
       ...
       const data = pData
        ...
        axios.post('http://localhost:5000/add/baby',data).then((response) => {
            ...
            <div className='my-3'>
                <div className="row my-3">
                    ...
                    <div className="col-md-10 text-start ">
                        <input onChange={handleChanges} className='form-control border-primary rounded"'  type="text" name="raisonForVisit" />
                    </div>
                </div>
            </div>
