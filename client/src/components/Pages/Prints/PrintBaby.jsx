...
function PrintBaby() {
  ...
  return (
    <div >
      ...
      <div className="container bg-light p-3 print">
        ...
        <h2>ورقة النزيلة في حالة مرافقة الطفل</h2>
        {
          data.map((item,i)=>(
            <div key={i}>
              ...
              <div className="row">
                  <label className="col-3 col-form-label fw-bold">سبب الولوج لدار الأمومة</label>
                  <div className="col-4">
                      <p className="fw-bold ">{item.raisonForVisit}</p>
                  </div>
              </div>
              <div className="row">
                  <label className="col-2 col-form-label fw-bold">هوية المرافقة</label>
                  <div className="col-4">
              ...
              <div className="row">
              <label className="col-2 col-form-label fw-bold">هوية الطفل</label>
              <label className="col-2 col-form-label fw-bold">الإسم</label>
                  <div className="col-3">
              ...
              <div className="row">
                <label className="col-3 col-form-label fw-bold">قرابة المرافقة للطفل </label>
                    <div className="col-9">
                        <p className="fw-bold">{item.bloodrelationship}</p>
                    </div>
                <label className="col-3 col-form-label fw-bold">المدة المحتمل للإقامة </label>
                    <div className="col-9">
              ...
              <div className="row ">
                <label className="col-2 col-form-label fw-bold"> اسم الأب</label>
                        <div className="col-4">
              ...
              <div className="row">
              <label className="col-3 col-form-label fw-bold">وسيلة النقل المستعملة </label>
                    <div className="col-4">
